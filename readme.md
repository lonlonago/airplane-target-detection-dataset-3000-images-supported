# Airplane target detection dataset 3000 images supported

# Body

Airplane Object Detection Dataset, 3000 images, supports Yolo format, electronic document, to cloud storage link upon purchase, convenient for download.
Ideal for object detection, image classification, and learning research, this is a virtual item, are accepted.
For those in need, simply purchase and you can ask me for details privately
